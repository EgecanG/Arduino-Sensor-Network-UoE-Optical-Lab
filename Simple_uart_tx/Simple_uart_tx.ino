// Arduino Due Board 1 (Sender and Receiver)
const int ledPin = 13;
...
void loop() {
  // Send message
  Serial1.println("Hello from Board 1");
  Serial.println("Sent message to Board 2"); // Debug message (optional)
